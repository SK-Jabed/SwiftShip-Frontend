...
export const router = createBrowserRouter([
  ...
  },
  {
    ...
    children: [
      {
        index: true,
        element: <Navigate to={"/dashboard/receiver/incoming-parcel"} />,
      },
  ...
  },
  {
    ...
    children: [
      {
        index: true,
        element: <Navigate to={"/dashboard/sender/create-parcel"} />,
      },
    ...
    children: [
      {
        index: true,
        element: (
          <Navigate to={"/dashboard/delivery-person/update-percel-status"} />
        ),
      },
