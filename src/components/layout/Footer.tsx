...
const Footer = () => {
    return (
      <footer className="bg-white">
        <div className="mx-auto container px-4 pt-14 pb-6 sm:px-6 lg:px-8">
          <div className="lg:flex lg:items-center lg:justify-between">
            ...
            <p className="mt-4 max-w-md text-center leading-relaxed text-gray-500 sm:text-left lg:mt-0">
              Deliver your product fast by our service
            </p>
          </div>
            ...
            <div className="text-center sm:text-left md:col-span-4 lg:col-span-2">
              ...
              <div className="mx-auto mt-8 max-w-md sm:ms-0">
                <p className="text-center leading-relaxed text-gray-500 ltr:sm:text-left rtl:sm:text-right">
                  Deliver your product as soon as possible by our service. Here we deliver you the best service.
                </p>
