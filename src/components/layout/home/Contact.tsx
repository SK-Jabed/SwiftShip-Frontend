...
const faqs = [
  {
    ...
    answer:
      "You can track your parcel using the tracking ID provided via SMS or email. Enter the tracking ID on our website or mobile app.",
  },
  {
    question: "What are your delivery hours?",
    answer:
      "We deliver from 9 AM to 8 PM, Monday to Saturday. Sunday deliveries are available for express services.",
  },
  {
    question: "How do I change my delivery address?",
    answer:
      "Contact our support team before the parcel is out for delivery. Address changes may incur additional charges.",
  },
  {
    question: "What if my parcel is damaged?",
    answer:
      "We provide full insurance coverage. Report damage within 24 hours with photos for immediate compensation.",
  },
];
        ...
        <div className="container mx-auto ">
          <div className="text-center">
            ...
            <p className="text-xl max-w-3xl mx-auto leading-relaxed">
              ...
              delivery? Our dedicated team is available 24/7 to assist you.
            </p>
          </div>
        </div>
      </section>
        ...
        <section className="py-10">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
            {contactMethods.map((method, index) => (
              <Card
                key={index}
                className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl border-0 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 group"
              >
                <div
                  className={`h-1 bg-gradient-to-r ${method.gradient}`}
                ></div>
        ...
        <section className="py-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {faqs.map((faq, index) => (
              <Card
                key={index}
                className="bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm border border-gray-200 dark:border-gray-700"
              >
